...
**Every manuscript or paper file MUST be reviewed before any commit or PR.**
...
3. **Consistency** -- notation, citation style (`\citet` vs `\citep`), terminology
...
3. Saves report to `quality_reports/` (e.g., `quality_reports/manuscript_report.md`)
