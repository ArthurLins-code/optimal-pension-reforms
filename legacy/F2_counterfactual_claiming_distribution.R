...
for (d in -6:15) {
  ...
  formula <- as.formula(paste0('claim_haz ~ i(year_quarter, `treat_', d, '`, ref = 2014.75) + `treat_', d,'` | year_quarter + points_norm + male + microrregiao + m_schooling + m_race + birth_year'))
...
for (g in c('[-6,-3]','[-2,-1]','[0,1]','[2,6]','[7,15]')) {
  ...
  formula <- as.formula(paste0('claim_haz ~ i(year_quarter, `treat_agg_', g, '`, ref = 2014.75) + `treat_agg_', g,'` | year_quarter + points_norm + male + microrregiao + m_schooling + m_race + birth_year'))
...
ggsave(plot_es1, filename = 'output/F/F2_eventstudy_all_1.pdf',
       height = 6, width = 6)
ggsave(plot_es2, filename = 'output/F/F2_eventstudy_all_2.pdf',
       height = 6, width = 6)
ggsave(plot_es3, filename = 'output/F/F2_eventstudy_all_3.pdf',
       height = 6, width = 6)
ggsave(plot_es4, filename = 'output/F/F2_eventstudy_all_4.pdf',
       height = 4, width = 6)

ggsave(plot_es_agg, filename = 'output/F/F2_eventstudy_aggregate.pdf',
       height = 6, width = 6)

ggsave(plot_count_2015, filename = 'output/F/F2_counterfactual_claiming_density_quarterly_2015.pdf',
       height = 4, width = 6)
ggsave(plot_count_2016, filename = 'output/F/F2_counterfactual_claiming_density_quarterly_2016.pdf',
       height = 4, width = 6)
ggsave(plot_count_2017, filename = 'output/F/F2_counterfactual_claiming_density_quarterly_2017.pdf',
       height = 4, width = 6)
ggsave(plot_count_2018, filename = 'output/F/F2_counterfactual_claiming_density_quarterly_2018.pdf',
       height = 2, width = 6)

ggsave(plot_count_agg, filename = 'output/F/F2_counterfactual_claiming_density_agg.pdf',
       height = 3, width = 5)
