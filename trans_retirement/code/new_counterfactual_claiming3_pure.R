...
ggsave(list_plots_freq_L[['1']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2015_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['2']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2015_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['3']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2015_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['4']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2016_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['5']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2016_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['6']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2016_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['7']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2016_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['8']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2017_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['9']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2017_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['10']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2017_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['11']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2017_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['12']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2018_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_L[['13']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_level_reform_claiming_frequency_quarterly_2018_Q2.pdf', height = 3, width = 5)


#Saving all contrafactual Slope reforms densities plots
ggsave(list_plots_freq_S[['-1']], filename  = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2014_Q4.pdf',height = 3, width = 5)
ggsave(list_plots_freq_S[['0']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2015_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['1']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2015_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['2']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2015_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['3']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2015_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['4']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2016_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['5']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2016_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['6']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2016_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['7']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2016_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['8']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2017_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['9']],  filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2017_Q2.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['10']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2017_Q3.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['11']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2017_Q4.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['12']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2018_Q1.pdf', height = 3, width = 5)
ggsave(list_plots_freq_S[['13']], filename = 'output/new_counter_claiming/new_counterfactual_claiming3_pure_slope_reform_claiming_frequency_quarterly_2018_Q2.pdf', height = 3, width = 5)
